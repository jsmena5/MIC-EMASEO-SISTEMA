...
CREATE TABLE incidents.incidents (
    ...
    CONSTRAINT incidents_decision_automatica_check CHECK (((decision_automatica)::text = ANY ((ARRAY['ERROR_TECNICO'::character varying, 'RECHAZO_CONFIABLE'::character varying, 'REVISION_REQUERIDA'::character varying, 'INCIDENTE_VALIDO'::character varying])::text[])))
);
