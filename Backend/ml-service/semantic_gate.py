...
_NEGATIVE_PROMPTS = [
    ...
    # ── Personas en entornos académicos y laborales ───────────────────────────
    "people working at computers in a classroom",
    "students sitting at desks in a lab",
    "a group of students in a university classroom",
    "people at a meeting or conference table",
    "a person writing or studying at a desk",
    "employees working in an office",
    "a person giving a presentation indoors",
    # ── Cascos y equipos de protección ───────────────────────────────────────
    "a motorcycle helmet on a desk or surface",
    "a bicycle or motorcycle helmet",
    "a construction hard hat or safety helmet",
    "safety equipment and protective gear",
    "a helmet resting on a chair or table",
    # ── Cables, herramientas y equipos ────────────────────────────────────────
    "cables and wires on a desk or floor",
    "electrical cables and power cords",
    "a tangle of charging cables indoors",
    ...
    "a bus or truck on the road",
    "parked motorcycles on a sidewalk",
    "a taxi or public transport vehicle",
    "a delivery truck or van",
    # ── Mercados y comercio callejero Ecuador ─────────────────────────────────
    "a street market stall with vegetables",
    "sacks of grain or potatoes at a market",
    "a street vendor selling food outdoors",
    "products displayed outside a store",
    "flower vendors and flower arrangements",
    "a food cart or street kiosk",
    "a canasto or woven basket with produce",
    "boxes of fruit stacked at a market",
    # ── Construcción — materiales organizados (no basura) ─────────────────────
    "stacked bricks or concrete blocks",
    "bags of cement or sand for construction",
    "wooden planks or boards stacked neatly",
    "construction materials at a building site",
    "a pile of sand or gravel for construction",
    "scaffolding on a building",
    # ── Naturaleza al nivel del suelo ─────────────────────────────────────────
    "fallen leaves on a clean sidewalk",
    "mud or dirt path in a field",
    "a puddle of water on the street",
    "grass or weeds growing on a sidewalk crack",
    "tree branches fallen on clean ground",
    "dry leaves and twigs on a path",
    # ── Animales urbanos y rurales ────────────────────────────────────────────
    "a dog or cat sitting on the street",
    "a pigeon or bird on the ground",
    ...
    "clothes drying outside a house",
    # ── Objetos cotidianos en exteriores ──────────────────────────────────────
    "a broom or mop leaning against a wall",
    "cleaning supplies and buckets outside",
    "cardboard boxes stacked neatly",
    "furniture placed outside temporarily",
    "a shopping cart near a store",
    "a bicycle or motorbike covered with a tarp",
    "flower pots and plants on a sidewalk",
    "a bench in a public park",
    "a door or gate of a house",
    "a street sign or traffic cone",
    # ── Deporte y recreación ──────────────────────────────────────────────────
    "children playing in a schoolyard",
    "people playing football on a field",
    "a basketball or football on the ground",
    "sports equipment on a field",
    "a playground with swings and slides",
    # ── Agua e infraestructura urbana ─────────────────────────────────────────
    "a water fountain or public tap",
    "a drainage grate or manhole cover",
